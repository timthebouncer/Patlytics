...
type Props={
    isAnalyzing: boolean
    onAnalyze: ({ patentId, companyName }) => Promise<{ patentId: string; companyName: string }>
}
const PatentComparisonForm:FC<Props> = React.memo(({onAnalyze, isAnalyzing}) => {
